...
export class UsuarioComponent implements OnInit,AfterViewInit
{
    ...
    obtenerUsuarios(){
      this._usuarioServicio.lista().subscribe({
        next: (data) => {
          ...
          this._utilidadServicio.mostrarAlerta("No se encontraton datos","Oops!")
        },
        error: (e) => {}
      });
  ...
  eliminarrUsuario(usuario:Usuario){
    
    Swal.fire({
      title: '¿Desea eliminar el usuario?', text: usuario.nombreCompleto,
      icon:"warning",
